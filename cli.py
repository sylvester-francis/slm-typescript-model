...
console.print("\n[bold green][OK] Data collection completed successfully![/bold green]\n")
...
console.print("\n[bold green][OK] Data preprocessing completed successfully![/bold green]\n")
except Exception as e:
...
console.print("\n[bold green][OK] Training completed successfully![/bold green]\n")
except KeyboardInterrupt:
console.print("\n[bold yellow][WARNING] Training interrupted by user[/bold yellow]\n")
...
try:
evaluation.main()
console.print("\n[bold green][OK] Evaluation completed successfully![/bold green]\n")
except Exception as e:
...
console.print("\n[bold green][OK] Upload completed successfully![/bold green]\n")
except Exception as e:
...
data_collection.main()
console.print("[bold green][OK] Collection complete[/bold green]\n")
else:
...
data_preprocessing.main()
console.print("[bold green][OK] Preprocessing complete[/bold green]\n")
else:
...
console.print("[bold green][OK] Training complete[/bold green]\n")
else:
...
evaluation.main()
console.print("[bold green][OK] Evaluation complete[/bold green]\n")
else:
